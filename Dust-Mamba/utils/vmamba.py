...
class Final_PatchExpand2D(nn.Module):
    ...
    #         nn.Conv2d(96, 24, kernel_size=3, stride=1, padding=1, bias=True),
    #         nn.BatchNorm2d(24),
    #         nn.ReLU(inplace=True)
    #     )
    #
...
class SS2D(nn.Module):
    ...
    def forward_corev0(self, x: torch.Tensor):
        ...
        # print(out_y[:, 0].shape, inv_y[:, 0].shape, wh_y.shape, invwh_y.shape)
        # print('-------------------------------------')
...
class VSSBlock(nn.Module):
    ...
    def forward(self, input: torch.Tensor):
        # print(self.hidden_dim, self.attn_drop_rate, self.d_state, self.drop)
...
class VSSM(nn.Module):
    def __init__(self, patch_size=4, in_chans=3, num_classes=1000, depths=[2, 2, 9, 2], depths_decoder=[2, 9, 2, 2],
        ...
        self.dims = dims
        # print(patch_size,in_chans,self.embed_dim)
